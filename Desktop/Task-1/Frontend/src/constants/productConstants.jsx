...
export const PRODUCTS_USER_REQUEST = "PRODUCTS_USER_REQUEST";
export const PRODUCTS_USER_SUCCESS = "PRODUCT_USER_SUCCESS";
export const PRODUCTS_USER_FAIL = "PRODUCTS_USER_FAIL"
